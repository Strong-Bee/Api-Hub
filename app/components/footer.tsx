    ...
    <footer className="border-t border-slate-800 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link href="/">
              <a className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold tracking-tight">API Hub</span>
              </a>
            </Link>
            <p className="text-sm text-slate-400 mb-4">
              Centralized API documentation for modern development teams.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/features">
                  <a className="text-slate-400 hover:text-white transition-colors">Features</a>
                </Link>
              </li>
              <li>
                <Link href="/pricing">
                  <a className="text-slate-400 hover:text-white transition-colors">Pricing</a>
                </Link>
              </li>
              <li>
                <Link href="/apis">
                  <a className="text-slate-400 hover:text-white transition-colors">APIs</a>
                </Link>
              </li>
              <li>
                <Link href="/changelog">
                  <a className="text-slate-400 hover:text-white transition-colors">Changelog</a>
                </Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/documentation">
                  <a className="text-slate-400 hover:text-white transition-colors">Documentation</a>
                </Link>
              </li>
              <li>
                <Link href="/guides">
                  <a className="text-slate-400 hover:text-white transition-colors">Guides</a>
                </Link>
              </li>
              <li>
                <Link href="/blog">
              ...
              <li>
                <Link href="/support">
                  <a className="text-slate-400 hover:text-white transition-colors">Support</a>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/careers">
                  <a className="text-slate-400 hover:text-white transition-colors">Careers</a>
                </Link>
              </li>
              <li>
                <Link href="/contact">
              ...
              <li>
                <Link href="/privacy">
                  <a className="text-slate-400 hover:text-white transition-colors">Privacy</a>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 text-sm text-slate-400 text-center">
          <p>© 2023 API Hub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
